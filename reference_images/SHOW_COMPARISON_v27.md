...
| Dome lattice: radial + concentric ribs on all four domes | #23, #04; STL has six raised ridges per dome | ribs on the measured ridges, purlins on the measured surface | ANCHORED |
...
| Arms: solid, no glazing | owner reading of #23 (2026-09-15); the #04 lattice reading set aside | all arm glazing removed | decision |
...
2. **Junction hardware.** Built in v2.8 as dock piers, REMOVED in v2.9 at the owner's request. Still UNPLACED: #23 shows something dark at the junctions; nothing modelled.
...
6. **Keel blade visibility.** DONE v2.9: translucent additive energy column between the fins (z -0.45 to -2.05, radius 0.10 to 0.03) plus the emissive spike.
