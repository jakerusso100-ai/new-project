...
85 nodes. Positions are in U (1 U = DOME-P radius). Placement class governs how much trust the position deserves.

| ID | Name | Kind | Layer | Bands | Exist. | Placement | States | Position (X,Y,Z) | Parent | Key evidence |
|---|---|---|---|---|---|---|---|---|---|---|
| `SHELL-DRUM` | Central drum (city deck and wall) | shell | L0 | V+1 V0 V-1 V-2 | A | LOCKED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | — | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `SHELL-LOWER-BODY` | Hanging keel (lower structural body) | shell | L0 | V-2 V-3 V-4 | A | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | — | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `SHELL-PLATES` | Drum rim plating | shell | L0 | V+1 V0 V-1 V-2 | A | PLACEHOLDER | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | SHELL-DRUM | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `SHELL-UNDERSIDE` | Keel tip with exit aperture | shell | L0 | V-4 | B | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,-1.60 | SHELL-LOWER-BODY | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `ARM-S1` | Radial arm to DOME-S1 | shell | L0 | V0 V-1 | A | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | SHELL-LOWER-BODY | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `ARM-S2` | Radial arm to DOME-S2 | shell | L0 | V0 V-1 | A | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | SHELL-LOWER-BODY | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `ARM-MB` | Radial arm to DOME-MB | shell | L0 | V0 V-1 | A | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | SHELL-LOWER-BODY | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `DOME-P` | Principal transparent dome | dome | L1 | V+3 | A | LOCKED | DS-01 DS-02 DS-03 DS-04 DS-05 | +0.00,+0.00,+0.00 | — | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#15 (S05E10 plaza destruction ground) |
| `DOME-S1` | Secondary dome 1 | dome | L1 | V0 V+1 | B | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | +2.00,+0.00,+0.00 | — | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `DOME-S2` | Secondary dome 2 | dome | L1 | V0 V+1 | B | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 | -1.00,+1.73,+0.00 | — | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `DOME-MB` | Mortyburg dome (detachable section) | dome | L1 | V0 V+1 V-1 | A | ANCHORED | DS-01 DS-02 DS-03 DS-04 DS-05 DS-06 | -1.00,-1.73,+0.00 | — | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram) |
| `PROP-PANEL-MAST` | Panel / antenna mast on a pod | prop | L6 | V+3 | A | PLACEHOLDER | DS-01 DS-02 DS-03 DS-04 DS-05 | -1.00,+1.73,+0.30 | DOME-S2 | reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view) |
...
| `UG-PORTAL-FLUID` | Portal-fluid production complex ('cave base') | machinery | L7 | V-2 | A | PROVISIONAL | DS-04 DS-05 | +0.10,+0.08,-0.19 | — | EPISODE_EVIDENCE_RICKMURAI_JACK.md (portal-fluid production / mines); DIALOGUE_ARCHITECTURE_CROSSREF.md D-006, D-007 |
| `UG-DIM-DRIVE` | Dimensional Drive chamber | machinery | L7 | V-3 | A | ANCHORED | DS-04 DS-05 | +0.00,+0.00,-0.50 | — | reference_images/CITADEL_IMAGE_GALLERY.md#17 (S05E10 rail cart); reference_images/CITADEL_IMAGE_GALLERY.md#13 (S05E10 Central Finite Curve platform) |
| `UG-CONTROL-ENCLOSURE` | Glass-domed control enclosure | machinery | L7 | V-3 | A | PROVISIONAL | DS-04 DS-05 | +0.20,+0.00,-0.60 | UG-DIM-DRIVE | reference_images/CITADEL_IMAGE_GALLERY.md#13 (S05E10 Central Finite Curve platform); EPISODE_EVIDENCE_RICKMURAI_JACK.md (glass-domed/control enclosure around the principal control interface) |
| `UG-PHOENIX-VATS` | Operation Phoenix vats | machinery | L7 | V-3 | A | PROVISIONAL | DS-04 DS-05 | +0.00,+0.00,-0.63 | UG-DIM-DRIVE | EPISODE_EVIDENCE_RICKMURAI_JACK.md (Operation Phoenix vats feed biological material into the drive process) |
| `UG-LAUNCH-CHAMBER` | Launch chamber (Evil Morty's spacecraft) | machinery | L7 | V-3 V-4 | A | ANCHORED | DS-04 DS-05 | +0.00,-0.06,-0.85 | — | EPISODE_EVIDENCE_SOLARICKS.md (surviving launch/technical chamber); EPISODE_EVIDENCE_RICKMURAI_JACK.md (spacecraft loaded into an exit chute) |
| `UG-EXIT-CHUTE` | Spacecraft exit chute | machinery | L7 | V-3 V-4 | A | ANCHORED | DS-04 DS-05 DS-06 | +0.00,+0.00,-1.23 | — | EPISODE_EVIDENCE_RICKMURAI_JACK.md (launched from the bottom of the Citadel); EPISODE_EVIDENCE_SOLARICKS.md (launch track) |
| `IF-MORTYBURG` | Mortyburg attachment interface | interface | L7 | V0 V-1 | A | PROVISIONAL | DS-01 DS-02 DS-03 DS-04 DS-05 | -0.56,-0.97,+0.00 | — | EPISODE_EVIDENCE_RICKMURAI_JACK.md (Mortyburg detachment); DIALOGUE_ARCHITECTURE_CROSSREF.md D-008, D-009 |
| `MB-THRUSTERS` | Mortyburg boosters / thrusters | machinery | L7 | V-1 | A | PROVISIONAL | DS-05 DS-06 | -1.00,-1.73,-0.20 | DOME-MB | DIALOGUE_ARCHITECTURE_CROSSREF.md D-010 |
...
| `RUIN-LAUNCH-CHAMBER` | Ruined launch chamber | ruin | L7 | V-3 | A | ANCHORED | DS-06 | +0.00,-0.06,-0.85 | UG-LAUNCH-CHAMBER | EPISODE_EVIDENCE_SOLARICKS.md (surviving launch/technical chamber) |
...
**Placement rationale:** Exterior #23 shows the city carried on a thick round drum whose rim wall rises above deck level and is capped by the glazed dome; the underside of the drum is where the keel and arms attach. Drum thickness (0.25 above deck, 0.28 below) is a ratio estimate from #23.

**Unknowns:** rim wall height; deck thickness; rim detailing

**Evidence:** reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram)

**Sub-features to model:** thick round deck; plated rim wall; arm roots at deck level; cyan rim lights

### SHELL-LOWER-BODY — Hanging keel (lower structural body)

**Placement rationale:** Founding hologram (gallery #04, S05E10) shows the lower body as an inverted cone/funnel under the central disc, ringed with concentric bands and tapering to a point at roughly one disc-radius depth. The v1 envelope (shallow tapered cylinder r 1.25->0.9, depth 0.65) is superseded. Apex depth and exact taper are ratio estimates from a single hologram frame. Exterior #23 confirms the hologram: a tall tapering keel hangs beneath the drum, faceted/plated, with a glowing cyan vertical energy strip down its face, ending in a spike. Keel top radius ≈ 0.45 R, depth ≈ 1.6 R below deck. Two independent sources → ANCHORED.

**Unknowns:** facet count; exact taper; whether the energy strip is the Drive exhaust or lighting

**Evidence:** reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram); EXTERIOR.md; SOURCE_INDEX.md (lower metallic structural plates); GEOMETRY_DATABASE.md G-002

**Sub-features to model:** faceted plated hull; cyan vertical energy strip (#23); spike tip; houses the Drive stack
...
### SHELL-UNDERSIDE — Keel tip with exit aperture

**Placement rationale:** The body tapers to a point (hologram #04) and the spacecraft launches from the bottom (S05E10); therefore the exit aperture is at the apex on the axis. The keel ends in a spike (#23); the exit aperture is at the tip.
...
**Placement rationale:** Hologram #04 shows each satellite pod connected to the central disc by a straight radial arm. Width and length are ratio estimates; whether the arm carries rail, road, or only structure is UNKNOWN (the Mortyburg arm must carry the rail spur). Exterior #23 shows the arms as wide flat decks (≈0.3 R wide) running from the drum rim to the pod rim at deck level.

**Unknowns:** width; section; what circulation it carries; whether arms are level with the ground plane

**Evidence:** reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram); CONTRADICTION_LOG.md C-002
...
**Placement rationale:** Strongest recurring exterior feature. Defines the unit U and the origin. Gallery #14/#15 show massive dark structural ribs of the dome overhead from inside the plaza; gallery #01 shows finer ribbed glazing between them. Exterior #23 settles the profile: a shallow, radially segmented glazed cap sitting on a thick drum, not a full hemisphere. Cap height ≈ 0.3 R. The hologram (#04) agrees. Two independent sources → LOCKED for the cap form; height ratio still an estimate.

**Unknowns:** cap height ratio (estimated 0.3); panel count; absolute radius

**Evidence:** reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#15 (S05E10 plaza destruction ground); reference_images/CITADEL_IMAGE_GALLERY.md#14 (S05E10 plaza destruction wide); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram); EXTERIOR.md; SOURCE_INDEX.md; GEOMETRY_DATABASE.md G-001; EVIDENCE_MATRIX.md E-002

**Sub-features to model:** radially segmented glazing panels (#23); primary dark structural ribs visible from inside (#14/#15); secondary glazing ribs (#01)

### DOME-S1 — Secondary dome 1

**Placement rationale:** Exterior #23 and the hologram #04 agree: three satellite discs, each a small drum with a segmented glazed cap, held out on long flat arms at ~120 deg. In #23 the pod diameter is roughly half the central drum and the pod centre sits about two drum radii out. Topology and ratios are therefore ANCHORED; azimuths relative to the city interior remain UNKNOWN.
...
**Evidence:** reference_images/CITADEL_IMAGE_GAP_CLOSURE_BATCH_02.md#23 (full exterior, orbital 3/4 view); reference_images/CITADEL_IMAGE_GALLERY.md#04 (S05E10 founding hologram); SOURCE_INDEX.md (three smaller domed districts); CONTRADICTION_LOG.md C-002

**Sub-features to model:** segmented glazed cap; short drum; small underside body

### DOME-S2 — Secondary dome 2

**Placement rationale:** See DOME-S1. A panel/antenna mast stands on one pod in #23 (PROP-PANEL-MAST, assigned to this pod as a placeholder).
...
**Placement rationale:** Mortyburg is a detachable domed section (A). #23 and #04 show all three satellite pods on arms; a pod on an arm is the only configuration that can disengage and fly off (S05E10), so Mortyburg = one of the three pods is now B. Which pod, and the azimuth, remain UNKNOWN.
...
**Placement rationale:** Chute from the launch chamber down the keel to the tip aperture. Length ≈ 0.75 U is set by the keel depth from #23.
